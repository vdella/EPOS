...
public:
    ...
    static const unsigned long INIT = library ? NOT_USED : 0xFFFFFFFF80200000; // RAM_BASE + 512 KB (will be part of the free memory at INIT)
    ...
    static const unsigned long SYS      = 0xFFFFFFFF80400000;
    static const unsigned long SYS_DATA = 0xFFFFFFFF80600000;
    static const unsigned long SYS_HIGH = 0xFFFFFFFF80800000;
