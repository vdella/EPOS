...
public:
    ...
    static const unsigned long RAM_TOP = 0x000000017fffffff;  // 2 GB + 128 MB (max 1536 MB of RAM => RAM + MIO < 2 G)
    ...
    static const unsigned long APP_HIGH = library ? RAM_TOP : 0x0000000200000000; // SYS - 1
    ...
    static const unsigned long IO       = 0x0000000000000000;                        // 0 (max 512 MB of IO = MIO_TOP - MIO_BASE)
    static const unsigned long SYS      = 0x0000000080300000;
    static const unsigned long SYS_DATA = 0x0000000080400000;
