...
void Agent::handle_thread()
{
    ...
    case CREATE1: {
        int (*entry)();
        in(entry);
        id(Id(THREAD_ID, reinterpret_cast<Id::Unit_Id>(new Adapter<Thread>(Thread::Configuration(Thread::READY, Thread::NORMAL), entry))));
    } break;
    case CREATE2: {
        int p1;
        int (*entry)(int);
        in(entry, p1);
        id(Id(THREAD_ID, reinterpret_cast<Id::Unit_Id>(new Adapter<Thread>(Thread::Configuration(Thread::READY, Thread::NORMAL), entry, p1))));
    } break;
    case CREATE3: {
        int p1, p2;
        int (*entry)(int, int);
        in(entry, p1, p2);
        id(Id(THREAD_ID, reinterpret_cast<Id::Unit_Id>(new Adapter<Thread>(Thread::Configuration(Thread::READY, Thread::NORMAL), entry, p1, p2))));
    } break;
    case CREATE4: {
        int p1, p2, p3;
        int (*entry)(int, int, int);
        in(entry, p1, p2, p3);
        id(Id(THREAD_ID, reinterpret_cast<Id::Unit_Id>(new Adapter<Thread>(Thread::Configuration(Thread::READY, Thread::NORMAL), entry, p1, p2, p3))));
    } break;
    case CREATE5: {
        int p1, p2, p3, p4;
        int (*entry)(int, int, int, int);
        in(entry, p1, p2, p3, p4);
        id(Id(THREAD_ID, reinterpret_cast<Id::Unit_Id>(new Adapter<Thread>(Thread::Configuration(Thread::READY, Thread::NORMAL), entry, p1, p2, p3, p4))));
    } break;
    case CREATE6: {
        int p1, p2, p3, p4, p5;
        int (*entry)(int, int, int, int, int);
        in(entry, p1, p2, p3, p4, p5);
        id(Id(THREAD_ID, reinterpret_cast<Id::Unit_Id>(new Adapter<Thread>(Thread::Configuration(Thread::READY, Thread::NORMAL), entry, p1, p2, p3, p4, p5))));
    } break;
    case CREATE7: {
        int p1, p2, p3, p4, p5, p6;
        int (*entry)(int, int, int, int, int, int);
        in(entry, p1, p2, p3, p4, p5, p6);
        id(Id(THREAD_ID, reinterpret_cast<Id::Unit_Id>(new Adapter<Thread>(Thread::Configuration(Thread::READY, Thread::NORMAL), entry, p1, p2, p3, p4, p5, p6))));
    } break;
    case CREATE8: {
        int p1, p2, p3, p4, p5, p6, p7;
        int (*entry)(int, int, int, int, int, int, int);
        in(entry, p1, p2, p3, p4, p5, p6, p7);
        id(Id(THREAD_ID, reinterpret_cast<Id::Unit_Id>(new Adapter<Thread>(Thread::Configuration(Thread::READY, Thread::NORMAL), entry, p1, p2, p3, p4, p5, p6, p7))));
    } break;
    case CREATE9: {
        int (*entry)();
        in(entry);
